...
package  {
	...
	public class main extends Sprite {
		...
		public  var VERSION:String = "2 Ichor patched by DZ";
			...
			*/
			...
			else
			{
				...
				loader.addEventListener(Event.COMPLETE, function(e:Event):void {
					...
					//
					if( this.chart_parameters['id'] )
						ExternalInterface.call(callback, this.chart_parameters['id']);
					else
		...
		public function find_data(): Boolean {
			...
			if (this.chart_parameters['inline_data']) { // added by qlg to handle inline_data
				this.parse_json(this.chart_parameters['inline_data']);
				return true;
			}
		...
		private function resize_radar(): ScreenCoordsBase {
			...
			var right:Number = this.stage.stageWidth - this.keys.get_right_width();
			// this object is used in the mouseMove method
			var sc:ScreenCoordsRadar = new ScreenCoordsRadar(top, 0, right, this.stage.stageHeight);
