package elements.axis {
	...
	public class YAxisLabelsBase extends Sprite {
		...
		private function make_label( json:Object ):YTextField
		{
			...
			fmt.font = lblStyle.rotate != null ? "spArial" : "Verdana";
			...
			else if ((lblStyle.rotate != null) && (lblStyle.rotate != 0))
			{
				tf.embedFonts = true;
				tf.antiAliasType = flash.text.AntiAliasType.ADVANCED;
			}
		...
		private function replace_magic_values(labelText:String, yVal:Number):String {
			...
			labelText = DateUtils.replace_magic_values(labelText, yVal);
			labelText = labelText.replace('#ygmdate', "#gmdate");
			labelText = DateUtils.replace_magic_values(labelText, yVal);
			return labelText;
		}
	}
