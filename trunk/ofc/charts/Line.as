package charts {
	...
	public class Line extends Base
	{
		...
		protected var dot_style:Properties;
		protected var on_show:Properties;
		protected var line_style:LineStyle;
	
		protected var on_show_timer:Timer;
		protected var on_show_start:Boolean;
		...
		public function Line( json:Object ) {
			...
			this.on_show_start = (this.on_show.get('type') != "");
			//
			//
		...
		protected function start_on_show_timer(): void {
		...
		protected function timedFunction(eventArgs:TimerEvent): void {
		...
		protected function still_animating(): Boolean {
			var i:Number;
			var tmp:Sprite;
